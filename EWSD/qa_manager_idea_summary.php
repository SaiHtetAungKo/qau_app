...
<div class="side-nav">
            ...
            <a class="nav-link" href="qa_manager_home.php"><i class="fa-solid fa-house"></i> Categories</a>
            <a class="nav-link-active" href="qa_manager_idea_summary.php"><i class="fa-solid fa-users"></i> Idea Reports</a>
